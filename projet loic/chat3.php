<html>
<?php
//prqles messages ne s'enregistrent pas en bdd??
session_start();
...
/*
Fonctions non appellées :
-document
-getOnlineUsers (si dans document)
-postMessage
-getMessages (si dans document)
...
*/
   ...
   <button onclick="bonjour()">testAjax</button>
...
?>
				...
				<table class="chat"><tr>		
					...
					<td valign="top" id="text-td">
						...
						<div id="text">
							<div id="loading">
								<center>
								<span class="info" id="info">Chargement du chat en cours...								
									<script type="text/javascript"> postMessage();</script><!--/////////////////////////////////////////////////////// -->
								</span><br />
					...
					<td valign="top" id="users-td"><div id="users">Chargement 
		<script type="text/javascript"> getOnlineUsers();</script> </div></td><!--/////////////////////////////////////////////////////// -->
		...
		<script type="text/javascript"> postMessage();</script>
		<script type="text/javascript"> getMessages();</script>
		<script type="text/javascript"> getOnlineUsers();</script>
		
		ne fait pas entierement les fonctions ajax? pourtant le prog defile bien...
		-->
	</body> 
<?php
